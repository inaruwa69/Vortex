...
int main() {
	...
	inet_pton(AF_INET, "VORTEX_IP", &serv.sin_addr); //converting IP into binary and storing into serv.sin_addr (just do "host vortex.labs.overthewire.org" to get the IP)
